...
(function(){
  var Button, calcuator, robot, reset, addClickToGetNumberWithAjaxToAllNumbers, addClickToCalculateSumOfAllButtonsAndShow, addResetToLeaveAtPlusArea, s1WaitingUserClick, s4ClickAtplusAndRobotClickAllButtonsRandomlyThenShowSum;
  Button = (function(){
  ...
  $(function(){
    ...
    s1WaitingUserClick();
    return s4ClickAtplusAndRobotClickAllButtonsRandomlyThenShowSum();
  });
  ...
  s4ClickAtplusAndRobotClickAllButtonsRandomlyThenShowSum = function(){
    robot.init();
