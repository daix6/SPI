...
(function(){
  var Button, calcuator, robot, reset, addClickToGetNumberWithAjaxToAllNumbers, addClickToCalculateSumOfAllButtonsAndShow, addResetToLeaveAtPlusArea, s1WaitingUserClick, s3ClickAtplusAndRobotClickAllButtonsThenShowSum;
  Button = (function(){
  ...
  $(function(){
    ...
    s1WaitingUserClick();
    return s3ClickAtplusAndRobotClickAllButtonsThenShowSum();
  });
  ...
  s3ClickAtplusAndRobotClickAllButtonsThenShowSum = function(){
    robot.init();
